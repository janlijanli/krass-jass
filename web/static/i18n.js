...
const STRINGS = {
  en: {
    ...
    "ai.toggle": "AI mode — changes the look, not the play",
    "ai.banner": "AI mode on — opponents enhanced",
    "ai.banner.sub": "Display only. The bots decide exactly as they did before.",
  ...
  de: {
    ...
    "ai.toggle": "KI-Modus — ändert die Optik, nicht das Spiel",
    "ai.banner": "KI-Modus aktiv — Gegner verstärkt",
    "ai.banner.sub": "Nur Anzeige. Die Bots entscheiden genau wie vorher.",
  ...
  fr: {
    ...
    "ai.toggle": "Mode IA — change l'aspect, pas le jeu",
    "ai.banner": "Mode IA activé — adversaires augmentés",
    "ai.banner.sub": "Affichage seulement. Les bots décident comme avant.",
  ...
  it: {
    ...
    "ai.toggle": "Modalità IA — cambia l'aspetto, non il gioco",
    "ai.banner": "Modalità IA attiva — avversari potenziati",
    "ai.banner.sub": "Solo grafica. I bot decidono esattamente come prima.",
