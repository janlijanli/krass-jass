...
export const ABOUT = {
  en: {
    ...
    "rules.double.p": "Only the highest bidder's opponents may double, until the second card is on the table: during the auction — at once, without waiting for their turn: the app asks you the moment an opponent bids — which ends it, or after the lead, when the app asks. A double doubles the stake. There is no redouble.",
    ...
    "rules.end.p": "Play is to 2000. A hand is always played out; if a team then has 2000 or more, the team with more points wins. A wild bid near the target is part of the tactics. After each hand the declarer deals, so the player on their right makes the first call.",
    ...
    "rules.bots.p": "They <b>bid</b> this language literally. To <b>double</b> they estimate how often the declarers make their number: deal the unseen cards many times over, weight each deal by the bids at the table, and play it out; under about a third, they double. They read the <b>auction</b> as statements about the other hands — never as facts: a bid makes deals that contradict it less likely, never impossible. In <b>play</b> they take as many card points as they can, as in the Schieber.",
    "rules.bots.warn": "Measured bot against bot: reading the auction is the largest gain this project has measured. Playing for the bid instead of for card points lost, so it is off; doubling on the estimate scores the same as a simple count of stoppers. The finer points of bidding (120 instead of 110 to keep the others under, Obenabe 40 to listen first) are not learned yet.",
  ...
  de: {
    ...
    "rules.double.p": "Nur die Gegner des Höchstbietenden dürfen doppeln, und zwar bis die zweite Karte auf dem Tisch liegt: während der Auktion — sofort, ohne auf die eigene Reihe zu warten: die App fragt dich, sobald ein Gegner bietet —, was sie beendet, oder nach dem ersten Ausspiel, wenn die App fragt. Doppeln verdoppelt den Einsatz. Rückdoppeln gibt es nicht.",
    ...
    "rules.end.p": "Gespielt wird bis 2000. Eine Runde wird immer fertig gespielt; hat danach ein Team 2000 oder mehr, gewinnt das Team mit mehr Punkten. Ein hohes Gebot kurz vor dem Ziel gehört zur Taktik. Nach jeder Runde gibt der Ansager, und der Spieler rechts von ihm sagt als Erster an.",
    ...
    "rules.bots.p": "Sie <b>bieten</b> nach dieser Sprache, wörtlich genommen. Zum <b>Doppeln</b> schätzen sie, wie oft die Ansager ihre Zahl erreichen: Sie verteilen die unbekannten Karten viele Male neu, gewichten jede Verteilung nach den Geboten am Tisch und spielen sie zu Ende; schaffen die Ansager es in weniger als etwa einem Drittel, wird gedoppelt. Die <b>Auktion</b> lesen sie als Aussagen über die anderen Hände — nie als Tatsachen: Ein Gebot macht Kartenverteilungen, die ihm widersprechen, unwahrscheinlicher, aber nie unmöglich. Beim <b>Spielen</b> holen sie so viele Kartenpunkte wie möglich, wie im Schieber.",
    "rules.bots.warn": "Gemessen Bot gegen Bot: Das Lesen der Auktion ist der grösste Gewinn, der in diesem Projekt je gemessen wurde. Aufs Gebot statt auf Kartenpunkte zu spielen hat verloren und ist darum aus; Doppeln per Schätzung schneidet gleich ab wie eine einfache Faustregel. Die Feinheiten des Bietens (taktisch 120 statt 110, erst Oben 40 zum Abhören) lernen die Bots noch nicht.",
  ...
  fr: {
    ...
    "rules.double.p": "Seuls les adversaires du plus offrant peuvent doubler, jusqu'à ce que la deuxième carte soit sur la table : pendant les enchères — aussitôt, sans attendre son tour : l'app te le demande dès qu'un adversaire annonce —, ce qui les arrête, ou après l'entame, quand l'app le demande. Doubler double la mise. Il n'y a pas de surcontre.",
    ...
    "rules.end.p": "On joue jusqu'à 2000. Une donne est toujours jouée jusqu'au bout ; si une équipe a alors 2000 ou plus, l'équipe qui a le plus de points gagne. Une grosse enchère près du but fait partie de la tactique. Après chaque donne, c'est le preneur qui donne, et le joueur à sa droite mise en premier.",
    ...
    "rules.bots.p": "Ils <b>annoncent</b> ce langage à la lettre. Pour <b>doubler</b>, ils estiment la fréquence à laquelle les preneurs atteignent leur nombre : ils redistribuent les cartes inconnues de nombreuses fois, pondèrent chaque donne par les enchères et la jouent jusqu'au bout ; en dessous d'environ un tiers, ils doublent. Ils lisent les <b>enchères</b> comme des affirmations sur les autres mains — jamais comme des faits : une enchère rend moins probables les donnes qui la contredisent, jamais impossibles. En <b>jouant</b>, ils prennent autant de points de cartes que possible, comme au Schieber.",
    "rules.bots.warn": "Mesuré bot contre bot : lire les enchères est le plus grand gain que ce projet ait mesuré. Jouer pour la mise plutôt que pour les points de cartes a perdu, c'est donc désactivé ; doubler sur l'estimation fait aussi bien qu'une simple règle. Les finesses des enchères (120 au lieu de 110 pour barrer, Obenabe 40 pour écouter d'abord) ne sont pas encore apprises.",
  ...
  it: {
    ...
    "rules.double.p": "Solo gli avversari di chi ha puntato di più possono raddoppiare, finché la seconda carta non è sul tavolo: durante l'asta — subito, senza aspettare il proprio turno: l'app te lo chiede appena un avversario punta —, e così finisce, o dopo l'uscita, quando l'app lo chiede. Il raddoppio raddoppia la posta. Il controraddoppio non esiste.",
    ...
    "rules.end.p": "Si gioca fino a 2000. Una mano si gioca sempre fino in fondo; se poi una squadra ha 2000 o più, vince la squadra con più punti. Una puntata alta vicino al traguardo fa parte della tattica. Dopo ogni mano dà chi ha puntato, e il giocatore alla sua destra punta per primo.",
    ...
    "rules.bots.p": "<b>Puntano</b> questo linguaggio alla lettera. Per <b>raddoppiare</b> stimano quanto spesso chi ha puntato raggiunge il suo numero: ridistribuiscono molte volte le carte sconosciute, pesano ogni distribuzione con le puntate al tavolo e la giocano fino in fondo; sotto circa un terzo, raddoppiano. Leggono l'<b>asta</b> come affermazioni sulle altre mani — mai come fatti: una puntata rende meno probabili le distribuzioni che la contraddicono, mai impossibili. <b>Giocando</b> prendono quanti più punti di carta possono, come nello Schieber.",
    "rules.bots.warn": "Misurato bot contro bot: leggere l'asta è il guadagno più grande mai misurato in questo progetto. Giocare per la posta invece che per i punti di carta ha perso, quindi è disattivato; raddoppiare sulla stima rende quanto una semplice regola. Le finezze dell'asta (120 invece di 110 per sbarrare, Obenabe 40 per ascoltare prima) non sono ancora apprese.",
